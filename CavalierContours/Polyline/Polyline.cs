    ...
    where T : struct, IFloatingPointIeee754<T>, IMinMaxValue<T>
{
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void SetVertex(int index, PlineVertex<T> vertex)
    {
        _vertexData[index] = vertex;
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void InsertVertex(int index, PlineVertex<T> vertex)
    {
        _vertexData.Insert(index, vertex);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void AddVertex(PlineVertex<T> vertex)
    {
