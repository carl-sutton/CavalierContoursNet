    ...
    where T : struct, IFloatingPointIeee754<T>
{
    ...
    public Vector2<T> Scale(T scaleFactor)
    {
        return new(scaleFactor * X, scaleFactor * Y);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T PerpDot(Vector2<T> other)
    {
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Vector2<T> SafeUnitPerp()
    {
        return Perp().SafeNormalize();
    }
